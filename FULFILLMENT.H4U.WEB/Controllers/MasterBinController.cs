...
{
    public class MasterBinController : Controller
    {
        IMasterBinRepository _repoCollection;
        public MasterBinController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public JsonResult INSERT([FromBody] MasterBin model)
        {
            Response resp = new Response();
        ...
        public JsonResult UPDATE([FromBody] MasterBin model)
        {
            Response resp = new Response();
        ...
        public async Task<JsonResult> GET_STATUS()
        {
            Response resp = new Response();

            try
            {
                resp = _repoCollection.GET_STATUS().Result;
            }
            catch (Exception ex)
            {
                resp.status = false;
        ...
        public async Task<JsonResult> GET_TYPE()
        {
            Response resp = new Response();

            try
            {
                resp = _repoCollection.GET_TYPE().Result;
            }
            catch (Exception ex)
            {
                resp.status = false;

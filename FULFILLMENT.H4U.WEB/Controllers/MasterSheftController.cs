...
{
    public class MasterSheftController : Controller
    {
        IMasterSheftRepository _repoCollection;

        public MasterSheftController(IConfiguration configuration)
        {
            _repoCollection = new MasterSheftRepository(configuration);
        }
        ...
        [HttpPost]
        public JsonResult INSERT([FromBody] MasterSheft model)
        {
            Response resp = new Response();
        ...
        public JsonResult UPDATE([FromBody] MasterSheft model)
        {
            Response resp = new Response();

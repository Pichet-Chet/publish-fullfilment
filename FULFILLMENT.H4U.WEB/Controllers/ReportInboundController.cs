...
{
    public class ReportInboundController : Controller
    {
        IGoodReceiveHeaderRepository _repoCollection;

        public ReportInboundController(IConfiguration configuration)
        {
            _repoCollection = new GoodReceiveHeaderRepository(configuration);
        }

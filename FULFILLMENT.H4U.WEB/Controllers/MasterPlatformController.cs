...
{
    public class MasterPlatformController : Controller
    {
        IMasterPlatformRepository _repoCollection;
        public MasterPlatformController(IConfiguration configuration)
        {
            _repoCollection = new MasterPlatformRepository(configuration);
        }
        ...
        [HttpPost]
        public JsonResult INSERT([FromBody] MasterPlatform model)
        {
            Response resp = new Response();
        ...
        public JsonResult UPDATE([FromBody] MasterPlatform model)
        {
            Response resp = new Response();

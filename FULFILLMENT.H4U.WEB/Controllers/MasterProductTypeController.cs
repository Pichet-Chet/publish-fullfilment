...
namespace FULFILLMENT_H4U.Controllers
{
    ...
    {
        IMasterProductTypeRepository _repoCollection;
        public MasterProductTypeController(IConfiguration configuration)
        {
            _repoCollection = new MasterProductTypeRepository(configuration);
        }
        ...
        [HttpPost]
        public JsonResult INSERT([FromBody] MasterProductsType model)
        {
            Response resp = new Response();
        ...
        public JsonResult UPDATE([FromBody] MasterProductsType model)
        {
            Response resp = new Response();

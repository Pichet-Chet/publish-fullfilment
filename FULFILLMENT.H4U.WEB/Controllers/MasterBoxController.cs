...
{
    public class MasterBoxController : Controller
    {
        IMasterBoxRepository _repoCollection;

        public MasterBoxController(IConfiguration configuration)
        {
            _repoCollection = new MasterBoxRepository(configuration);
        }
        ...
        [HttpPost]
        public JsonResult INSERT([FromBody] MasterBox model)
        {
            Response resp = new Response();
        ...
        public JsonResult UPDATE([FromBody] MasterBox model)
        {
            Response resp = new Response();

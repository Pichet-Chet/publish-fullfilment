...
{
    public class WarehouseStockManagementController : Controller
    {
        private readonly ILogger<HomeController> _logger;

        private IWebHostEnvironment _hostingEnvironment;

        IStockManagementRepository _repoCollection;

        public WarehouseStockManagementController(ILogger<HomeController> logger, IConfiguration configuration, IWebHostEnvironment hostingEnvironment)
        {
            _logger = logger;

            _hostingEnvironment = hostingEnvironment;
            _repoCollection = new StockManagementRepository(configuration);
        ...
        public JsonResult UPDATE([FromBody] StockManualLog model)
        {
            Response resp = new Response();

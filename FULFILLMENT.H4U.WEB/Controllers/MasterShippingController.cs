...
{
    public class MasterShippingController : Controller
    {
        IMasterShippingRepository _repoCollection;

        public MasterShippingController(IConfiguration configuration)
        {
            _repoCollection = new MasterShippingRepository(configuration);
        }
        ...
        [HttpPost]
        public JsonResult INSERT([FromBody] MasterShipping model)
        {
            Response resp = new Response();
        ...
        public JsonResult UPDATE([FromBody] MasterShipping model)
        {
            Response resp = new Response();

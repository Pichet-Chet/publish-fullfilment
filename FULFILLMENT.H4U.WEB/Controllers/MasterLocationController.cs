...
namespace FULFILLMENT_H4U.Controllers
{
    ...
    {
        IMasterLocationRepository _repoCollection;

        public MasterLocationController(IConfiguration configuration)
        {
            _repoCollection = new MasterLocationRepository(configuration);
        }
        ...
        [HttpPost]
        public JsonResult INSERT([FromBody] MasterLocation model)
        {
            Response resp = new Response();
        ...
        public JsonResult UPDATE([FromBody] MasterLocation model)
        {
            Response resp = new Response();

...
namespace FULFILLMENT_H4U.Repositories
{
    public class MasterShippingRepository : IMasterShippingRepository
    {
        ...
        public MasterShippingRepository(IConfiguration configuration)
        {
        ...
        public async Task<Response> GET_ALL(FilterModel param)
        {
            ...
            List<MasterShipping> listData = new List<MasterShipping>();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apimastershipping/get_all?{filterString}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        ...
                        {
                            listData = JsonConvert.DeserializeObject<List<MasterShipping>>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> GET_DETAIL(int id)
        {
            ...
            MasterShipping listData = new MasterShipping();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apimastershipping/detail?id={id}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        listData = JsonConvert.DeserializeObject<MasterShipping>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> INSERT(MasterShipping param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apimastershipping/insert");
        ...
        public async Task<Response> UPDATE(MasterShipping param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apimastershipping/update");
        ...
        public async Task<Response> DELETE(int id)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apimastershipping/delete?id={id}");

...
namespace FULFILLMENT_H4U.Repositories
{
    public class PicklistItemRepository : IPicklistItemRepository
    {
        ...
        public PicklistItemRepository(IConfiguration configuration)
        {
        ...
        public async Task<Response> GET_ALL_BY_HEADER(int headerId)
        {
            ...
            List<ViewPicklistItemModel> listData = new List<ViewPicklistItemModel>();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiPicklistItem/GET_ALL_BY_HEADER?id={headerId}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        ...
                        {
                            listData = JsonConvert.DeserializeObject<List<ViewPicklistItemModel>>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> GET_DETAIL(int id)
        {
            ...
            ViewPicklistItemModel listData = new ViewPicklistItemModel();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiPicklistItem/detail?id={id}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        listData = JsonConvert.DeserializeObject<ViewPicklistItemModel>(apiResponse.output_data.ToString());

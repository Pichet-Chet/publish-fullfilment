...
namespace FULFILLMENT_H4U.Repositories
{
    public class ManagementUserRepository : IManagementUserRepository
    {
        ...
        public ManagementUserRepository(IConfiguration configuration)
        {
        ...
        public async Task<Response> GET_ALL()
        {
            ...
            List<ViewSysUserModel> listData = new List<ViewSysUserModel>();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiManagementUser/get");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        ...
                        {
                            listData = JsonConvert.DeserializeObject<List<ViewSysUserModel>>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> GET_COUNT()
        {
            ...
            UserCount listData = new UserCount();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiManagementUser/GET_COUNT");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        if (resp.message != Constants.DATA_NOT_FOUND)
                        {
                            listData = JsonConvert.DeserializeObject<UserCount>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> GET_DETAIL(int id)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiManagementUser/detail?id={id}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        listData = JsonConvert.DeserializeObject<SysUser>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> UPDATE(SysUser param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiManagementUser/UPDATE");
        ...
        public async Task<Response> INSERT(SysUser param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiManagementUser/INSERT");
        ...
        public async Task<Response> CHANGE_PASSWORD(SysUser param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiManagementUser/CHANGE_PASSWORD");
        ...
        public async Task<Response> EDIT_PROFILE(SysUser param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiManagementUser/EDIT_PROFILE");

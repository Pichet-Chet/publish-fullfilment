...
{
    public class PicklistHeaderRepository : IPicklistHeaderRepository
    {
        ...
        public PicklistHeaderRepository(IConfiguration configuration)
        {
        ...
        public async Task<Response> GET_ALL(FilterModel param)
        {
            ...
            List<ViewPicklistHeaderModel> listData = new List<ViewPicklistHeaderModel>();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiPicklistHeader/get_all?{filterString}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        ...
                        {
                            listData = JsonConvert.DeserializeObject<List<ViewPicklistHeaderModel>>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> GET_DETAIL(int id)
        {
            ...
            ViewPicklistHeaderModel listData = new ViewPicklistHeaderModel();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiPicklistHeader/detail?id={id}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        listData = JsonConvert.DeserializeObject<ViewPicklistHeaderModel>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> INSERT(TransactionPicklist param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiPicklistHeader/insert");

...
namespace FULFILLMENT_H4U.Repositories
{
    public class PurchaseOrderHeaderRepository : IPurchaseOrderHeaderRepository
    {
        ...
        public PurchaseOrderHeaderRepository(IConfiguration configuration)
        {
        ...
        public async Task<Response> GET_ALL(FilterModel param)
        {
            ...
            List<ViewPurchaseOrderHeaderModel> listData = new List<ViewPurchaseOrderHeaderModel>();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiPurchaseOrderHeader/get_all?{filterString}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        ...
                        {
                            listData = JsonConvert.DeserializeObject<List<ViewPurchaseOrderHeaderModel>>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> GET_DETAIL(int id)
        {
            ...
            ViewPurchaseOrderHeaderModel listData = new ViewPurchaseOrderHeaderModel();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiPurchaseOrderHeader/detail?id={id}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        listData = JsonConvert.DeserializeObject<ViewPurchaseOrderHeaderModel>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> INSERT(transactionPurchaseOrder param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiPurchaseOrderHeader/insert");
        ...
        public async Task<Response> UPDATE(transactionPurchaseOrder param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiPurchaseOrderHeader/update");
        ...
        public async Task<Response> CANCEL(transactionPurchaseOrder param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiPurchaseOrderHeader/cancel");

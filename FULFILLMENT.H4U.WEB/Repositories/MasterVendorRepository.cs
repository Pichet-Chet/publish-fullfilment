...
{
    public class MasterVendorRepository : IMasterVendorRepository
    {
        ...
        public MasterVendorRepository(IConfiguration configuration)
        {
        ...
        public async Task<Response> GET_ALL(FilterModel param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apimastervendor/get_filter?{filterString}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        ...
                        {
                            listData = JsonConvert.DeserializeObject<List<MasterVendor>>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> GET_BALANCE_MOVEMENT(FilterModel param)
        {
            ...
            List<ViewVendorBalanceLogModel> listData = new List<ViewVendorBalanceLogModel>();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apimastervendor/GET_BALANCE_MOVEMENT?{filterString}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        if (resp.message != Constants.DATA_NOT_FOUND)
                        {
                            listData = JsonConvert.DeserializeObject<List<ViewVendorBalanceLogModel>>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> GET_ACTIVE()
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apimastervendor/get_active");
        ...
        public async Task<Response> GET_DETAIL(int id)
        {
            ...
            MasterVendor listData = new MasterVendor();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apimastervendor/detail?id={id}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        listData = JsonConvert.DeserializeObject<MasterVendor>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> INSERT(MasterVendor param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apimastervendor/insert");
        ...
        public async Task<Response> UPDATE(MasterVendor param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apimastervendor/update");
        ...
        public async Task<Response> DELETE(int id)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiMasterVendor/delete?id={id}");

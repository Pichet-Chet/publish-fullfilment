...
{
    public class MasterBoxRepository : IMasterBoxRepository
    {
        ...
        public MasterBoxRepository(IConfiguration configuration)
        {
        ...
        public async Task<Response> GET_ALL(FilterModel param)
        {
            ...
            List<MasterBox> listData = new List<MasterBox>();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiMasterBox/get_all?{filterString}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        ...
                        {
                            listData = JsonConvert.DeserializeObject<List<MasterBox>>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> GET_DETAIL(int id)
        {
            ...
            MasterBox listData = new MasterBox();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiMasterBox/detail?id={id}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        listData = JsonConvert.DeserializeObject<MasterBox>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> INSERT(MasterBox param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiMasterBox/insert");
        ...
        public async Task<Response> UPDATE(MasterBox param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiMasterBox/update");
        ...
        public async Task<Response> DELETE(int id)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiMasterBox/delete?id={id}");

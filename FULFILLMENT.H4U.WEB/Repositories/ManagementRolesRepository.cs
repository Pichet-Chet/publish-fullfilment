...
namespace FULFILLMENT_H4U.Repositories
{
    public class ManagementRolesRepository : IManagementRolesRepository
    {
        ...
        public ManagementRolesRepository(IConfiguration configuration)
        {
        ...
        public async Task<Response> GET_ALL(FilterModel param)
        {
            ...
            List<SysRoleGroup> listData = new List<SysRoleGroup>();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiManagementRole/GET_ALL?{filterString}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        ...
                        {
                            listData = JsonConvert.DeserializeObject<List<SysRoleGroup>>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> GET_DETAIL(int id)
        {
            ...
            SysRoleGroup listData = new SysRoleGroup();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiManagementRole/detail?id={id}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        if (resp.message != Constants.DATA_NOT_FOUND)
                        {
                            listData = JsonConvert.DeserializeObject<SysRoleGroup>(apiResponse.output_data.ToString());
        ...
        public async Task<Response> INSERT(SysRoleGroup param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiManagementRole/insert");
        ...
        public async Task<Response> UPDATE(SysRoleGroup param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiManagementRole/update");
        ...
        public async Task<Response> LIST_GET_ALL(FilterModel param)
        {
            ...
            ViewSysRoleModel listData = new ViewSysRoleModel();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiManagementRole/LIST_GET_ALL?{filterString}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        if (resp.message != Constants.DATA_NOT_FOUND)
                        {
                            listData = JsonConvert.DeserializeObject<ViewSysRoleModel>(apiResponse.output_data.ToString());

                            if (listData.viewSysRoleListModel.Count > 0)
                            {
                                resp.output_data = listData;
                            }
                        }
        ...
        public async Task<Response> LIST_UPDATE(SysRoleList param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiManagementRole/list_update");

...
{
    public class ReportStockRepository : IReportStockRepository
    {
        ...
        public ReportStockRepository(IConfiguration configuration)
        {
        ...
        public async Task<Response> GET_STOCK_BALANCE_ITEM(int productId)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiStock/GET_STOCK_BALANCE_ITEM?productId={productId}");
        ...
        public async Task<Response> GET_STOCK_MOVE_MENT(FilterModel param)
        {
            ...
            List<ViewStockMovementModel> listData = new List<ViewStockMovementModel>();
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/apiStock/GET_STOCK_MOVE_MENT?{filterString}");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (resp.status == true)
                    {
                        if (resp.message != Constants.DATA_NOT_FOUND)
                        {
                            listData = JsonConvert.DeserializeObject<List<ViewStockMovementModel>>(apiResponse.output_data.ToString());

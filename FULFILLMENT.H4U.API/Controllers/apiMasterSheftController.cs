...
namespace FULFILLMENT.H4U.API.Controllers
{
    ...
    [ApiController]
    public class apiMasterSheftController : ControllerBase
    {
        private readonly IMasterSheftRepository repoCollection;

        public apiMasterSheftController()
        {
            repoCollection = new MasterSheftRepository();
        }
        ...
        [HttpPost]
        [Route("INSERT")]
        public async Task<IActionResult> INSERT(MasterSheft param)
        {
        ...
        [HttpPut]
        [Route("UPDATE")]
        public async Task<IActionResult> UPDATE(MasterSheft param)
        {

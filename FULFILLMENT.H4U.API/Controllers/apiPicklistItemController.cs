...
namespace FULFILLMENT.H4U.API.Controllers
{
    ...
    [ApiController]
    public class apiPicklistItemController : ControllerBase
    {
        private readonly IPicklistItemRepository repoCollection;

        public apiPicklistItemController()
        {
            repoCollection = new PicklistItemRepository();
        }

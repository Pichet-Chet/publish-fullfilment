...
namespace FULFILLMENT.H4U.API.Controllers
{
    ...
    [ApiController]
    public class apiPrinterController : ControllerBase
    {
        private readonly IPrinterRepository repoCollection;

        public apiPrinterController()
        {
            repoCollection = new PrinterRepository();
        }

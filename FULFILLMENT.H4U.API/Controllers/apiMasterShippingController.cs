...
namespace FULFILLMENT.H4U.API.Controllers
{
    ...
    [ApiController]
    public class apiMasterShippingController : ControllerBase
    {
        private readonly IMasterShippingRepository repoCollection;

        public apiMasterShippingController()
        {
            repoCollection = new MasterShippingRepository();
        }
        ...
        [HttpPost]
        [Route("INSERT")]
        public async Task<IActionResult> INSERT(MasterShipping param)
        {
        ...
        [HttpPut]
        [Route("UPDATE")]
        public async Task<IActionResult> UPDATE(MasterShipping param)
        {

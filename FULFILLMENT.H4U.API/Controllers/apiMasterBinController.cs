...
namespace FULFILLMENT.H4U.API.Controllers
{
    ...
    [ApiController]
    public class apiMasterBinController : ControllerBase
    {
        private readonly IMasterBinRepository repoCollection;

        public apiMasterBinController()
        {
            repoCollection = new MasterBinRepository();
        }
        ...
        [HttpGet]
        [Route("GET_STATUS")]
        public async Task<IActionResult> GET_STATUS()
        {
            try
            {
                var result = await repoCollection.GET_STATUS();
        ...
        public async Task<IActionResult> GET_TYPE()
        {
            try
            {
                var result = await repoCollection.GET_TYPE();

...
namespace FULFILLMENT.H4U.API.Repository
{
    ...
    {
        MasterVendorService service = new MasterVendorService();
        ...
        public async Task<Response> GET_BALANCE_MOVEMENT(FilterModel param)
        {
            ...
            try
            {
                var result = await service.GET_BALANCE_MOVEMENT(param);
        ...
        public async Task<Response> GET_ACTIVE()
        {
            ...
            try
            {
                var result = service.GET_ACTIVE().Result;
        ...
        public async Task<Response> SEARCH(string textSearch)
        {
            ...
            try
            {
                var result = service.SEARCH(textSearch).Result;

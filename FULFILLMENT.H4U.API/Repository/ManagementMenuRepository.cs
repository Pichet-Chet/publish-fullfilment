...
{
    public class ManagementMenuRepository : IManagementMenuRepository
    {
        ManagementMenuService service = new ManagementMenuService();
        ...
        public async Task<Response> LIST_GET_ALL(FilterModel param)
        {
            ...
            try
            {
                var result = await service.LIST_GET_ALL();
        ...
        public async Task<Response> LIST_GET_DETAIL(int id)
        {
            ...
            try
            {
                var result = await service.LIST_GET_DETAIL(id);
        ...
        public async Task<Response> LIST_INSERT(SysMenuList param)
        {
            ...
            try
            {
                var result = await service.LIST_INSERT(param);
